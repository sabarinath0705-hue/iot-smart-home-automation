...
export const initialDevices: Device[] = [
  { id: '1', name: 'Main Lights', type: 'light', room: 'Living Room', isOn: true, value: 75, colorTemp: 4000, schedule: { timeOff: '23:00' } },
  { id: '2', name: 'AC', type: 'ac', room: 'Living Room', isOn: false, value: 24, mode: 'cool', schedule: { timeOn: '17:30' } },
  ...
  { id: '6', name: 'Coffee Maker', type: 'plug', room: 'Kitchen', isOn: false, isResponsive: false },
